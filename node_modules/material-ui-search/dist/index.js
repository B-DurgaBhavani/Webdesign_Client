        ...
        value: function render() {
            ...
            return React__default.createElement(
                ...
                React__default.createElement(
                    ...
                    React__default.cloneElement(closeIcon, {
                        classes: { root: classes.icon }
                    })
                )
            );
...
SearchBar.defaultProps = {
    className: '',
    closeIcon: React__default.createElement(ClearIcon, { style: { color: colors.grey[500] } }),
    disabled: false,
    placeholder: 'Search',
    searchIcon: React__default.createElement(SearchIcon, { style: { color: colors.grey[500] } }),
    style: null,
    value: ''
};
...
var SearchBar$1 = withStyles(styles$1)(SearchBar);
...
SearchbarProvider = styles.withStyles(styles$2)(SearchbarProvider);

var SearchbarProvider$1 = reactRedux.connect(function (state) {
    return {
...
exports.SearchbarProvider = SearchbarProvider$1;
exports.withSearchbar = withSearchbar;
exports.searchbarReducer = reducer;
exports.searchbarActions = actions;
